# animal-concept (roadmap placeholder - concept only)

**Not a working example. Not generated. Not printable.** See
`../README.md` for why this whole directory is concept-only.

An original organic-form animal figure concept (e.g. a small desk
figurine). No CAD source, mesh, or render exists for this concept, and
none will be generated until a future Blender local-automation phase
and/or a Meshy safety/cost approval gate exist (see
`../../../docs/roadmap.md`).
